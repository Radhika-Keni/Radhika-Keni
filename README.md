...
Each of my projects has an elborate readme so ya'll can get a concise summary of the problem statement at hand , a sample input to the program ,a sample output  from the program (wherever applicable) and an overview of the solution/code before you actually go and get your hands dirty with the code.
